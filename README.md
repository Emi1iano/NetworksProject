...
On another terminal run `python client.py` before you run this command make sure your friend has their server running  
Now on your client you should see all the songs your friend has that you don't  
Give the index of the song you want to request to download it from your friend
